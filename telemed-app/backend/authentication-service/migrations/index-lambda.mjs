...
import {dynamicSeedUp} from './user-seed.mjs';
...
export const handler = async (event, context) => {
  const params = {
    ...
    seedParams: event.params.seedParams,
  };
  ...
  try {
    ...
    await dbMigrate2.up();
    if (params.seedParams) {
      await dynamicSeedUp(params.seedParams, {
      ...
      console.log('seedParams is not provided skipping the dynamic seed');
    }
  } catch (error) {
